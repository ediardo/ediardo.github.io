...
<div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0267.jpg" alt="" >}}</div>
  ...
  <div class="masonry-item">{{< gallery-photo src="photos/insects/Dragonfly Petaluma.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0294.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0159-5.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0255-2.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0082.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0176.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0026.jpg" alt="" >}}</div>
    <div class="masonry-item">{{< gallery-photo src="photos/insects/Te Puke-1.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/Moth Petaluma-2.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0212.jpg" alt="" >}}</div>
  ...
  <div class="masonry-item">{{< gallery-photo src="photos/insects/Okere Falls.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0035.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_0177.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/Te Puke 2026-01-10-31.jpg" alt="" >}}</div>
  <div class="masonry-item">{{< gallery-photo src="photos/insects/IMG_1134.jpg" alt="" >}}</div>`
</div>
